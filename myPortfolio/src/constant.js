...
webapp: "https://gncipl-global-connect.vercel.app/"
  ...
  description:
    "A full-stack real-time ride-booking platform inspired by Uber, featuring live location tracking with Leaflet and route calculation using Ola Maps APIs. Built with a scalable Spring Boot backend and WebSockets for real-time communication, enabling instant ride requests, driver matching, live ride status updates, and dynamic fare estimation. Includes secure JWT authentication, role-based access control (RBAC), separate rider and captain dashboards, and a production-ready architecture deployed with Docker and MongoDB Atlas.",
  image: uberClone,
  tags: [
    "React JS",
    "Spring Boot",
