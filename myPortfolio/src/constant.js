...
webapp: "https://gncipl-global-connect.vercel.app/"
  ...
  description:
    "A full-stack real-time ride-booking platform inspired by Uber, featuring live location tracking using Leaflet and route calculation via Ola Maps API. Built with a high-performance Golang backend and WebSockets for real-time communication, enabling instant ride requests, driver matching, and live ride status updates. Includes separate dashboards for riders and drivers, secure JWT-based authentication with role-based access control (RBAC), and a seamless, scalable architecture for real-time ride dispatching.",
  image: uberClone,
  tags: [
    "React JS",
    "Golang",
